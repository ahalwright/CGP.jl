...
function construct_pheno_net( p::Parameters, nreps::Int64, numcircuits::Int64; pheno_file::String="", use_lincircut::Bool=false )
  ...
  for ch_ints in ch_ints_list
    ...
    for ch_int in ch_ints
      if use_lincircuit
        ch = int_to_vect( ch_int, p.levelsback, p.numinputs, funcs )  # ch is a lincircuit
      else
