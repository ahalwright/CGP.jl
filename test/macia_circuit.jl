...
out8 = OutputNode(6)
out9 = OutputNode(7)
c0 = Chromosome(p0,[in1,in2],[int3,int4,int5,int6,int7],[out8,out9],0.0)
...
out7 = OutputNode(6)
c1 = Chromosome(p1,[in1,in2],[int3,int4,int5,int6],[out7],0.0)
...
out11 = OutputNode(6)
out12 = OutputNode(10)
c2 = Chromosome(p2,[in1,in2],[int3,int4,int5,int6,int7,int8,int9,int10],[out11,out12],0.0)
